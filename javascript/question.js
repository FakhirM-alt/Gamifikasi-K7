const questions = [
  {
    ...
    questions: [
      ...
      {
        question: "What is the name of the PixelPals's mascot?",
        options: ["Pixel", "Pip", "Pipa", "Pie"],
        correctAnswer: 2,
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: "What is one of the rules for a good design?",
        options: ["Pick random colors", "Create space", "Use 4 fonts", "Be less friendly"],
        correctAnswer: 1,
      },
      {
        question: "Which of these brands uses logotype?",
        options: ["Pepsi", "Starbucks", "LG", "FedEx"],
        correctAnswer: 3,
      },
      {
        question: "Which of these brands uses logogram?",
        options: ["Coca-Cola", "Facebook", "Linux", "Disney"],
        correctAnswer: 2,
      },
      {
        question: "What color that ISN'T a neatural?",
        options: ["Black", "Yellow", "Grey", "White"],
        correctAnswer: 1,
      },
      {
